...
import static ru.blogspot.lifesider.myapplication.result.intankres;
import static ru.blogspot.lifesider.myapplication.result.probinres;
...
public class inputfuel extends AppCompatActivity {
    ...
    public void onClicksbrosfuel(View view) {
        deleteFile();
    }
}
